...
var author$project$Main$urlToRealm = function (url) {
	...
	return A2(elm$core$String$startsWith, 'http://localhost:8080/ember-app', str) ? elm$core$Result$Ok(
		author$project$Main$EmberApp(str)) : (A2(elm$core$String$startsWith, 'http://localhost:8080/react-app', str) ? elm$core$Result$Ok(
		author$project$Main$ReactApp(str)) : elm$core$Result$Err('Could not match URL \'' + (str + '\' to any Realm')));
};
	...
	var content = function () {
		...
		switch (_n0.$) {
			...
			default:
				var realm = _n0.a;
				if (realm.$ === 'EmberApp') {
					return A3(elm$html$Html$node, 'ember-app', _List_Nil, _List_Nil);
				} else {
					return A3(elm$html$Html$node, 'react-app', _List_Nil, _List_Nil);
				}
		}
	}();
	return {
